...
def train(sess, env, control_net, estimate_net, action_bound, init_pose):
    ...
    saver.restore(sess, "/home/jeon/work/hand/results/hand-v0/20180211193406/model/model.ckpt")
    ...
    for i in range(MAX_EPISODES):
        ...
        # if i > EXPLORATION_STEPS:
        #     action_gradients = estimate_net.action_gradients(np.reshape(action, (1, 5)),
        #                                                      np.reshape(desired_state, (1, 4)))
        #
